# Reto
# Desarrolla una concesionaria de vehículos en la cual se puedan gestionar las compras y 
# ventas de vehículos. Un usuario podrá ver los vehículos disponibles, su precio y 
# realizar la compra de uno. Aplica los conceptos de programación orientada a objetos vistos en este ejercicio.
